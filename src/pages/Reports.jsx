  ...
  return (
    <div className="min-h-screen p-6 pt-24 bg-gradient-to-br from-blue-50/20 to-purple-50/20 dark:from-gray-900/20 dark:to-gray-800/20 dark:text-gray-200">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-10 p-4 rounded-xl bg-white/40 dark:bg-gray-700/40 shadow-inner">
        <select className="border border-white/50 dark:border-gray-600 bg-white/80 dark:bg-gray-800 p-3 rounded-xl w-full md:w-1/2 text-gray-800 dark:text-gray-200 focus:ring-blue-500"
      ...
      <div className="grid gap-6 md:grid-cols-3 mb-10">
        <div className="backdrop-blur-md bg-white/30 dark:bg-gray-700/30 p-6 rounded-3xl shadow-xl">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        <div className="bg-white/40 dark:bg-gray-800/40 p-6 rounded-3xl shadow-2xl">
          <h2 className="text-2xl font-bold mb-4 text-center">Expense Breakdown by Category</h2>
          {expenseCategoryData.length > 0 ? (
            <ResponsiveContainer width="100%" height={350}>
              <PieChart>
                <Pie data={expenseCategoryData} cx="50%" cy="50%" outerRadius={120} fill="#8884d8" dataKey="value"
          ...
          ) : <p className="text-center text-gray-500 py-12">No Expense data for the selected period.</p>}
        </div>

        <div className="bg-white/40 dark:bg-gray-800/40 p-6 rounded-3xl shadow-2xl">
          <h2 className="text-2xl font-bold mb-4 text-center">Monthly Income vs. Expense Trends</h2>
          ...
          ) : <p className="text-center text-gray-500 py-12">No transaction data.</p>}
        </div>
      </div>
    </div>
  );
